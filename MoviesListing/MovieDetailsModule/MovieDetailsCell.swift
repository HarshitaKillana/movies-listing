...
final class MovieDetailsCell: UITableViewCell {
    ...
    func setupFields(movieDetails: MovieDetails) {
        ...
        let plotTitle = NSAttributedString(string: "Plot:", attributes: [
            NSAttributedString.Key.foregroundColor: UIColor.systemYellow
            ])
            attributedString.append(plotTitle)
        if let plotText = movieDetails.plot {
                let plotContent = NSAttributedString(string: "\n\(plotText)", attributes: [
                    NSAttributedString.Key.foregroundColor: plotLabel.textColor
                ])
                attributedString.append(plotContent)
            }
            plotLabel.attributedText = attributedString
